...
import labelImg from "@/assets/label-real.jpg";
      ...
      <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
        ...
        <div className="space-y-4">
          <div className="overflow-hidden rounded-2xl border border-border shadow-sm">
            <img src={labelImg} alt="Этикетка со составом и сертификатами" loading="lazy" className="w-full object-cover" />
          </div>
          <div className="overflow-hidden rounded-2xl border border-border shadow-sm">
            <img src={kitImg} alt="Комплект: банки, мерная ложка, информационная вкладка" loading="lazy" className="w-full object-cover" />
          </div>
        </div>
      </div>
    </div>
