...
const faqs = [
  {
    ...
    a: "Принимать 1 раз в день по 1/3 чайной ложки (около 25 мг) во время еды, запивая водой. Порошок можно также растворить в тёплой воде или добавить в напиток. Курс — 2 месяца, затем перерыв 1 месяц. Точную дозировку лучше согласовать с врачом.",
  },
  {
