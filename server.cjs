...
const FAQ = [
  ...
  },
  {
    ...
    answer: 'Доставляем по всей России через СДЭК и Почту России.\nСтоимость и сроки доставки сориентируем при оформлении заказа — зависит от города.\n\nПо Иркутску — бесплатно.',
  },
  {
...
ДОСТАВКА: по Иркутску бесплатно, по РФ — СДЭК или Почта России. Стоимость и сроки доставки не называй — говори "сориентируем при оформлении заказа"
